        ...
        <section className="mb-32 text-gray-800">
          ...
          <div className="grid lg:grid-cols-2 gap-6 lg:gap-x-12">
            ...
            <div className="mb-6 lg:mb-0 ">
              <div className="block rounded-lg shadow-lg bg-white h-full dark:bg-slate-800 ">
                <div className="p-6 border-b border-gray-300 text-center">
                  <p className="uppercase mb-4 text-sm">
                    <strong className='dark:text-white'>완료된 일정 : {todoList.filter((todo: todoType) => todo.weather === "1").length}</strong>
                  </p>
                  <h3 className="text-2xl mb-6">
                    <strong className='text-black dark:text-white'>맑음</strong>
            ...
            <div className="mb-6 lg:mb-0">
              <div className="block rounded-lg shadow-lg bg-white h-full dark:bg-slate-800">
                <div className="p-6 border-b border-gray-300 text-center">
                  <p className="uppercase mb-4 text-sm">
                    <strong className='dark:text-white'>완료된 일정 : {todoList.filter((todo: todoType) => todo.weather === "3").length}</strong>
                  </p>
                  <h3 className="text-2xl mb-6">
                    <strong className='text-black dark:text-white'>구름</strong>
            ...
            <div className="mb-6 lg:mb-0">
              <div className="block rounded-lg shadow-lg bg-white h-full dark:bg-slate-800">
                <div className="p-6 border-b border-gray-300 text-center">
                  <p className="uppercase mb-4 text-sm">
                    <strong className='dark:text-white'>완료된 일정 : {todoList.filter((todo: todoType) => todo.weather === "4").length}</strong>
                  </p>
                  <h3 className="text-2xl mb-6">
                    <strong className='text-black dark:text-white'>흐림</strong>
            ...
            <div className="mb-6 lg:mb-0">
              <div className="block rounded-lg shadow-lg bg-white h-full dark:bg-slate-800">
                <div className="p-6 border-b border-gray-300 text-center">
                  <p className="uppercase mb-4 text-sm">
                    <strong className='dark:text-white'>완료된 일정 : {todoList.filter((todo: todoType) => todo.weather === "2").length}</strong>
                  </p>
                  <h3 className="text-2xl mb-6">
                    <strong className='text-black dark:text-white'>기타</strong>
                  </h3>
                </div>
                <div className="p-6">
                  <ol className="list-inside">
